...
public class MainPage {
    ...
    private final By imageScooter = By.xpath(".//img[@alt = 'Scooter blueprint']"); // картинка скутера на главной странице
    private final By buttonAcceptCookie = By.id("rcc-confirm-button"); // кнопка принять куки
    ...
    public void clickOrder(int indexButton) {
        switch (indexButton) {
            ...
            case 1:
                ...
                new WebDriverWait(driver, Duration.ofSeconds(5)).until(driver -> (buttonOrder.isDisplayed()));
                buttonOrder.click();
                break;
        }
    }
